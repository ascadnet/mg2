...
function validateForm(id)
{
    ...
    $.ajax({
        type: "POST",
        url: "functions/ajax_check_form.php",
        data: $('#' + id).serialize(),
        dataType: "json",
...
function show_loading()
{
    ...
    top = top + 8;
    var final_content = '<div class="anet_loading" onclick="return close_loading();"><img src="' + pf_url + '/templates/imgs/loading.gif" width="107" height="16" alt="Loading" border="0" /></div>';
