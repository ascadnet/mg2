...
class Validator {
     ...
     * Allows 5551003999, 555-100-3999
     */
    function phone()
    {
    ...
    function get_error()
    {
        $error_array = array(
            ...
            'phone' => '%name% is not a valid phone number. Accepted formats are "5551112222" or "555-111-2222".',
    ...
    function get_ajax_error()
    {
        $error_ajax_array = array(
            ...
            'basicsymbols' => '%name% must contain letters, numbers, spaces, or dashes only.',
            'fixed_values' => '%name% is not an acceptable value for this field.',
            'phone' => 'This is not a valid phone number. Accepted formats are "5551112222" or "555-111-2222".',
